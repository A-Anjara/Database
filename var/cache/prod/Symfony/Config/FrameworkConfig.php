...
class FrameworkConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @deprecated since Symfony 7.4
     */
    public function csrfProtection(bool|array $value = []): \Symfony\Config\Framework\CsrfProtectionConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
    ...
    /**
     * @template TValue of string|bool|array
     * @param TValue $value
     * Lock configuration
     ...
     * @deprecated since Symfony 7.4
     */
    public function lock(string|bool|array $value = []): \Symfony\Config\Framework\LockConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
     ...
     * @deprecated since Symfony 7.4
     */
    public function semaphore(string|bool|array $value = []): \Symfony\Config\Framework\SemaphoreConfig|static
    {
        $this->_hasDeprecatedCalls = true;
        if (!\is_array($value)) {
